...
<script type="text/javascript" src="${ctx}/mgr/js/ux/case/classicCaseUploadcheck.js"></script>
...
<body style="overflow: auto;">
				...
				<div data-options="region:'center',border:false,singleSelect:true"
					title='上传申请列表信息' style="height:auto">
			...
			<div id="addWin" class="easyui-dialog" title="进行单个拒绝审批" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:500px;height:420px;">
				<form id="addForm" class="formbody">
					<div class="formtitle"><span>单个审批拒绝</span></div>
						...
						<ul class="forminfo">
							<!-- <li><label>成果名称</label><label id="patName"></label></li>
							<li><label>文件名称</label><label id="fileName"></label></li>  -->
							<li><label>备注不通过原因（不能为空）</label>
							<textarea rows="8" cols="38" style="border:1px solid skyblue;padding:8px;" id="remark" class="left easyui-validatebox"
								data-options="required:true,missingMessage:'原因不能为空'"></textarea>
							</li>
			...
			<!--批量拒绝  -->
			<div id="refuseWin" class="easyui-dialog" title="进行多个审批拒绝" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:500px;height:420px;">
				<form id="addForm" class="formbody">
					<div class="formtitle"><span>多个审批拒绝</span></div>
					<table id="data_refuse" style="width:100%;higth:auto;">
						<!--加载批量拒绝的列表  -->
					</table>	
					<br>
					<input id="btnToMoreRefuse" type="button" class="btn" value="提交"/>	
				</form>
			</div>
		...
		<div id="watchWin" title="查看成果信息" 
				...
				<div class="form_div" style="height:650px;">
					...
					<div class="btn_div" style="height:50px;" id="comment"></div>
					<!-- <div id="left-bottom2">
						<ul>
