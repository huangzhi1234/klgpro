...
<script type="text/javascript" src="${ctx}/mgr/js/ux/stDoc/dicss.js"></script>
...
<script type="text/javascript" src="${ctx}/mgr/js/ux/stDoc/stssDocInfo.js"></script>
<style type="text/css">
/*取消全选按钮 */
...
<script>
	...
	/*用来提醒上传是否成功  */
		 ...
		 */
		$('#dict_tree').tree({
			url : path + "/docDicInfo/tree2.action",
			lines : true,
	...
	<div id="dict_layout" class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center',title:'文档列表'" style="padding:5px;">
			...
			<div id="addWin" title="上传文档信息文件" 
				style="float:left;width:950px;higth:auto;display: none;">
				<form id="addForm" name="addForm" class="formbody"
					enctype="multipart/form-data"
					action="${ctx}/mgr/stssDocInfo/add.json?stDoc=stssDocInfo"
