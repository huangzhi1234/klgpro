...
<script type="text/javascript" src="${ctx}/mgr/js/ux/stDoc/dic.js"></script>
...
<script type="text/javascript" src="${ctx}/mgr/js/ux/stDoc/stDocInfo.js"></script>
...
<script>
	...
	/*用来提醒上传是否成功  */
		 ...
		 */
		$('#dict_tree').tree({
			url : path + "/docDicInfo/tree.action",
			lines : true,
...
<!--导航栏&&权限控制-->
		...
		<div data-options="region:'center',title:'文档列表'" style="padding:5px;">
			<div id="class_required"
				...
				<div data-options="region:'center',border:false,singleSelect:true"
					title='文档基本信息' style="height:auto;width:95%;">
			...
			<div id="addWin" title="上传文档信息文件" 
				...
				<form id="addForm" name="addForm" class="formbody"
					...
					action="${ctx}/mgr/stDocInfo/add.json?stDoc=stDocInfo"
	...
	<div style="display: none;" id="pic">
		<div class="imgdiv">
   			<img id="imgss" src="projAndDetailImg.jsp" title="在线预览">
		</div>
	</div>
