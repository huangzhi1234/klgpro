...
<script type="text/javascript"
	src="${ctx}/mgr/js/ux/stDoc/stUpHistory.js"></script>
		...
		<div id="class_required">
			...
			<form id="schForm">
				<ul class="seachform" style="width:100%;">
					...
					<li><label>文档类型</label> <input type="text"  name="doctype"  id="doctype" class="easyui-combobox dfinput" style="width:200px;"data-options="valueField:'id', textField:'text',panelHeight:'auto'"/></li>
