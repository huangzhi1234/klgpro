 ...
 */
@Controller
public class StssDocController implements ServletContextAware{
	@Autowired
	...
	@RequestMapping(value = "/stssDocInfo")
	public String toProInfoMessagePage() {
		return "stDoc/stssDocInfo";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/stssDocInfo/list.json", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @return 操作结果json对象
	 */
	@RequestMapping(value = "/stssDocInfo/delete.json", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value = "/stssDocInfo/deleteFile", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/stssDocInfo/add.json", method = RequestMethod.POST)
	@ResponseBody
	public ModelAndView add(@RequestParam(value = "fileOne", required = false) CommonsMultipartFile fileOne,
		...
		if (stDocInfo != null) {
				...
				try {
					...
					stdocUploadcheck.setType(2);//标识，1为开发，2为实施
	 ...
	 * @param response
	 */
	@RequestMapping(value = "/stssDocInfo/downloadFile", method = RequestMethod.GET)
	@ResponseBody
...
//	 * @return
//	 */
//	@RequestMapping(value = "/stssDocInfo/applyMore.json", method = RequestMethod.POST)
//	@ResponseBody
...
//				stdocDowncheck.setType(2);//标识，1为开发，2为实施
//				UserBean userBean = (UserBean) request.getSession().getAttribute("user");
