package com.ibb.web.controller.classicCase;
 ...
 */
@Controller
public class ClassicCaseController implements ServletContextAware{
	@Autowired
	 ...
	 * @return
	 */
	@RequestMapping(value = "/classicCase/list.json", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @return 操作结果json对象
	 */
	@RequestMapping(value = "/classicCase/delete.json", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value = "/classicCase/deleteFile", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/classicCase/add.json", method = RequestMethod.POST)
	@ResponseBody
	public ModelAndView add(@RequestParam(value = "fileOne", required = false) CommonsMultipartFile fileOne,
		...
		if (stDocInfo != null) {
				...
				try {
					...
					stdocUploadcheck.setType(4);//标识，4 经典案例
	 ...
	 * @param response
	 */
	@RequestMapping(value = "/classicCase/downloadFile", method = RequestMethod.GET)
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/classicCase/applyMore.json", method = RequestMethod.POST)
	@ResponseBody
