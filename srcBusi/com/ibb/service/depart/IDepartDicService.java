package com.ibb.service.depart;
...
public interface IDepartDicService extends IBaseService<DepartDicInfo, Integer>{
	public Page<DicInfo> getListByCondition(final ConditionQuery query, final int pn, final int pageSize);
	/**
