...
<script type="text/javascript" src="${ctx}/mgr/js/ux/patch/dict2.js"></script>
...
<script type="text/javascript" src="${ctx}/mgr/js/ux/patch/patchInfo2.js"></script>
...
<script>
	$(function() {
		 ...
		 */
		$('#dict_tree').tree({
			url : path + "/proDicInfo/stree.action",
			lines : true,
	...
	<div id="dict_layout" class="easyui-layout" data-options="fit:true">
			...
			<div class="easyui-panel" data-options="fit:true,border:false">
				<ul id="dict_tree">
					<div id="dict_menu" class="easyui-menu" style="width:120px;">
						<div id="add_spat" onclick="dict_addNode()" data-options="iconCls:'icon-add'">新增项目节点</div>
						<div id="edit_spat" onclick="dict_updateNode()"
							data-options="iconCls:'icon-edit'">编辑项目节点</div>
						<div id="del_spat" onclick="dict_delNode()" data-options="iconCls:'icon-remove'">删除项目节点</div>
					</div>
				</ul>
			</div>
		</div>
		...
		<div data-options="region:'center',title:'成果列表'" style="padding:5px;">
			<div id="class_required"
				...
				<!--功能按钮，项目基本信息-->
				<div id="tb_patchInfo">
					<a href="javascript:void(0);" id="btnAdd_patchInfo2"
						class="easyui-linkbutton"
						data-options="iconCls:'icon-add',plain:true">新增</a> <a
						href="javascript:void(0);" id="btnEdit_patchInfo2"
						class="easyui-linkbutton"
						data-options="iconCls:'icon-edit',plain:true">编辑</a> <a
						href="javascript:void(0);" id="btnWatch_patchInfo2"
						class="easyui-linkbutton"
						data-options="iconCls:'icon-detail',plain:true">查看详细信息</a> <a
						href="javascript:void(0);" id="btnDelete_patchInfo2"
						class="easyui-linkbutton"
						data-options="iconCls:'icon-remove',plain:true">删除</a><a
						href="javascript:void(0);" id="btnApply_patchInfo2" class="easyui-linkbutton"
			...
			<div id="addWin" title="新增成果信息"
				...
				<form id="addForm" name="addForm" class="formbody"
					...
					action="${ctx}/mgr/patchInfo/add2.json?patch=spatchInfo"
			...
			<div id="editWin" title="编辑成果信息" 
				...
				<div class="form_div">
					<form id="editForm" class="formbody" enctype="multipart/form-data"
						action="${ctx}/mgr/patchInfo/update2.json?patch=spatchInfo"
						method="post" style="float:left;width:100%;higth:auto">
				...
				<div id="form_divWin" class="form_div" style="height:1350px;">
					...
					<div id="left-top">
						<ul>
							...
							<li id="file2" style="width:350px;height:30px;"><a id="fileDown"
								class="atn">下载</a>
							</li>
						</ul>
					</div>
				...
				<div class="form_div" style="height:650px;">
					...
					<div id="left-top2">
						<ul>
							...
							<li id="file1" style="width:350px;height:30px;"><a id="fileDown2"
								class="atn">下载</a></li>
						</ul>
					</div>
					<div id="right2">
