...
<script type="text/javascript"
	src="${ctx}/mgr/js/ux/patch/patEdit.js"></script>
		...
		<div id="class_required">
			...
			<form id="schForm">
				<ul class="seachform">
					...
					<li><label>成果名称</label> <input type="text" class="scinput" name="patName" /></li>
					<li><label>文件名称</label> <input type="text" class="scinput" name="fileName" /></li>
					<!--借用remark字段便于后台接收  -->
					<li><label>申请人</label> <input type="text" class="scinput" name="remark" /></li>
					<!--借用agreeTime字段便于后台接收  -->
					<li><label>审批人</label> <input type="text" class="scinput" name="agreeTime" /></li>
			...
			<div data-options="region:'center',border:false,singleSelect:true" style="height:auto" id="upData">
				<table id="datagridOfPatUp"></table>
			</div>
			...
			<div data-options="region:'center',border:false,singleSelect:true" style="height:auto" id="downData">
				<table id="datagridOfPatDown"></table>
			</div>
			...
			<form id="editForm2" class="formbody">
				<div class="formtitle"><span>修改上传审批信息</span></div>
					...
					<ul class="forminfo">
						...
						<li><label>&nbsp;</label><input id="pat_up_updata" type="button" class="btn" value="确认更新"/></li>
					</ul>
			</form>
		</div>
				...
				<div class="formtitle"><span>修改下载审批信息</span></div>
					...
					<ul class="forminfo">
						...
						<li><label>备注</label><textarea
								...
								data-options="required:true,missingMessage:'项目描述不能为空'"></textarea></li>
						<li><label>&nbsp;</label><input id="pat_down_updata" type="button" class="btn" value="确认更新"/></li>
					</ul>
			</form>
		</div>
</body>
