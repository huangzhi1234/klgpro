...
<script type="text/javascript"
	src="${ctx}/mgr/js/ux/patch/uploadHistory.js"></script>
	<!-- <script type="text/javascript">
		$("#cc").calendar({
		...
		<div id="class_required">
			...
			<form id="schForm">
				<ul class="seachform" style="width:100%;">
					<li><label>成果名称</label>
					<input type="text" name="patName" class="scinput" />
					</li>
					<li><label>文件名称</label>
					<input type="text" name="fileName" class="scinput" />
					</li>
					<li><label>状态</label>
					<!-- <select style="border: 1px solid #ccc;width: 70px;height:30px;">
						<option>申请中</option>
						<option>已通过</option>
						<option>不通过</option>
					</select> -->
					...
					<li><label>类型</label>
						...
						name="type" class="easyui-combobox dfinput"
						data-options="editable:false,panelHeight:'auto',
						valueField: 'label',textField: 'value',data: [{label: '',value: '全部'},{label: '1',value: '研发'},{label: '2',value: '实施'}]"
						 />
					</li>
					<li>
						<label>申请日期</label>
						<input name="time" class="easyui-datebox dfinput" 
							data-options="editable:true,sharedCalendar:'#cc',height:32" />
					</li>
					<!-- <li>
						<label>截止日期</label>
			...
			<!-- <div id="tb_apply">
				<a href="javascript:void(0);" id="btnAdd_apply"
					class="easyui-linkbutton"
					data-options="iconCls:'icon-add',plain:true">批量申请</a> 
			</div> -->
