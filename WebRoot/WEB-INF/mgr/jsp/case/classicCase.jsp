...
<script type="text/javascript" src="${ctx}/mgr/js/ux/case/casedic.js"></script>
...
<script type="text/javascript" src="${ctx}/mgr/js/ux/case/classicCase.js"></script>
<style type="text/css">
/*取消全选按钮 */
...
<script>
	...
	/*用来提醒上传是否成功  */
		 ...
		 */
		$('#dict_tree').tree({
			url : path + "/docDicInfo/tree4.action",
			lines : true,
		...
		<div data-options="region:'center',title:'文档列表'" style="padding:5px;">
			...
			<div id="addWin" title="上传文档信息文件" 
				...
				<form id="addForm" name="addForm" class="formbody"
					...
					action="${ctx}/mgr/classicCase/add.json?stDoc=classicCase"
					...
					<div class="form_div">
						...
						<ul style="border-top:1px;border-color:#006C9C;border-style:solid;">
							...
							<li>
								<label>所属项目名称：</label>
								<input name="proname" type="text" style="height: 24px" class="easyui-validatebox" data-options="required:true,missingMessage:'所属项目名称不能为空'">
							</li>
							
							<li>
								<label>所属行业：</label>
								<input type="text" id="industry" name="industry" class="easyui-combobox dfinput left" data-options="editable:false,valueField:'id', textField:'text', panelHeight:'auto'" />
							</li>
							
							<li>
								<label>所属领域：</label>
								<input type="text" id="area" name="area" class="easyui-combobox dfinput left" data-options="editable:false,valueField:'id', textField:'text', panelHeight:'auto'" />
							</li>
				...
				<div class="form_div" style="height:500px;">
					...
					<div id="right2">
						<ul>
							...
							<li id="proname2" style="text-align:left;width:200px;"></li>
							
							<li style="text-align:center;width:150px;">所属行业：</li>
							<li id="industry2" style="text-align:left;width:200px;"></li>
							
							<li style="text-align:center;width:150px;">所属领域：</li>
							<li id="area2" style="text-align:left;width:200px;"></li>
	...
	<div id="getDown" class="easyui-dialog" title="申请下载" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:500px;height:420px;">
		<form id="causeForm" class="formbody">
			<div class="formtitle"><span>申请下载</span></div>
				<input type="hidden" name="docDownId" id="docDownId" /> 
				<ul class="forminfo">
